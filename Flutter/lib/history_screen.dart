...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  String selectedTimeRange = '6h'; // Default to 6 hours
      ...
      if (gasLevel > 2500) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('Warning: Gas level too high! (${gasLevel.toStringAsFixed(1)})'),
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: isSelected ? const Color(0xFF2D3250) : Colors.grey[300]!,
                  ),
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: Text(
                  metric,
                  style: TextStyle(
                    color: isSelected ? const Color(0xFF2D3250) : Colors.grey[600],
                    fontWeight: isSelected ? FontWeight.w600 : FontWeight.normal,
                  ),
                ),
              ),
  ...
  Widget _buildChart() {
    ...
    final series = [
      charts.Series<HistoryData, DateTime>(
        ...
        colorFn: (_, __) => charts.ColorUtil.fromDartColor(const Color(0xFF2D3250)),
      )
    ];
